...
type NormalUser struct {
	...
	Avatar       string  `gorm:"column:avatar;type:varchar(300);default:'default_gray_avatar.jpeg'" form:"avatar" json:"avatar" xml:"avatar"` //默认是一个空头像  （可以在后端放一个空头像，大家进来默认这个url）
